...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title1 = customtkinter.CTkLabel(self, text="Добро пожаловать в нашу бибилиотеку", corner_radius=5)

        self.title1.place(x=70, y=10)
        
        self.title4 = customtkinter.CTkLabel(self, text="Для дальнейших действий авторизуйтесь", corner_radius=5)

        self.title4.place(x=70, y=40)

        self.title2 = customtkinter.CTkLabel(self, text="Введите логин и пароль", corner_radius=6)
